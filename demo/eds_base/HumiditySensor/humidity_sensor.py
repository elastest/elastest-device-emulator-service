...
class HumiditySensor(XAE):

    def __init__(self, *args, **kw):
        super(HumiditySensor, self).__init__(*args, **kw)
    ...
    def _on_register(self):
        ...
        self.request_cnt = Container(resourceName='request',
                labels=['elastest:humidity:request'],
                maxNrOfInstances=5)
        ...
        self.response_cnt = Container(resourceName='response',
                labels=['elastest:sensor:humidity:response'],
                maxNrOfInstances=5)
        ...
        self.status_cnt = Container(resourceName='status',
                labels=['elastest:sensor:humidity:status'],
                maxNrOfInstances=5)
