...
client = CoapClient("coap://localhost:4000", client_port=9876)
...
# client = CoapClient("coap://130.149.247.214:8090", client_port=9876)
# client = CoapClient("coap://130.149.247.215:8090", client_port=9876)
...
client.post('m2m/applications/MyApp/containers',
            ...
            content_type='application/json').then(resultPrinter, errorPrinter)
#
client.post('m2m/applications/MyApp/containers/MyCon/contentInstances',
...
client.post('m2m/applications/MyApp/containers/MyCon/contentInstances',
            ...
            content_type='application/json').then(resultPrinter, errorPrinter)
client.post('m2m/applications/MyApp/containers/MyCon/contentInstances',
            '{"contentInstance": {"id":"MyIns3", "content":{"textContent":"world"}}}',
            content_type='application/json').then(resultPrinter, errorPrinter)
client.post('m2m/applications/MyApp/containers/MyCon/contentInstances',
            '{"contentInstance": {"id":"MyIns4", "content":{"textContent":"world"}}}',
            content_type='application/json').then(resultPrinter, errorPrinter)
#
#
# client.delete("m2m/applications/MyApp/containers/MyCon/contentInstances/MyIns").then(resultPrinter, errorPrinter)
# client.delete("m2m/applications/MyApp/containers/MyCon").then(resultPrinter, errorPrinter)
# client.delete("m2m/applications/MyApp?x-etsi-correlationID=6&x-etsi-trpdt=2&x-etsi-rcat=0").then(resultPrinter, errorPrinter)
