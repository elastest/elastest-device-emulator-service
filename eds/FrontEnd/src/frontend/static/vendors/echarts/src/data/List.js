...
define(function (require) {
     ...
     *        Dimension can be concrete names like orchestrator, y, z, lng, lat, angle, radius
     *        Or a ordinal number. For example getDimensionInfo(0) will return 'orchestrator' or 'lng' or 'radius'
     */
     ...
     *
     * @example
     *  list.each('orchestrator', function (orchestrator, idx) {});
     *  list.each(['orchestrator', 'y'], function (orchestrator, y, idx) {});
