...
gulp.task('debugrefs', function(){
  return gulp.src('debug/motor.html')
...
gulp.task('testrefs', function(){
  return gulp.src('test/motor.html')
...
gulp.task('docsclean', function(next){
  return gulp.src(['documentation/js/all.min.js', 'documentation/css/all.min.css', 'documentation/motor.html'])
    .pipe( clean({ read: false }) )
  ;
});

gulp.task('docshtmlmin', function(){
  return gulp.src('documentation/motor.html')
    .pipe( $.htmlmin({
...
gulp.task('docsrefs', function(){
  return gulp.src([ 'documentation/motor.html', 'documentation/template.html' ])
