...
def get_client(m2m_ep, use_xml=False):
    try:
        return _clients[(m2m_ep, use_xml)]
    except KeyError:
        # TODO: make connection_timeout and concurrency configurable
        client = _clients[(m2m_ep, use_xml)] = OneM2MHTTPClient(m2m_ep, use_xml)
        return client
...
class OneM2MHTTPClient(OneM2MClient):
    def __init__(self, m2m_ep, use_xml):
        ...
        client = HTTPClient(host, port, connection_timeout=120.0, concurrency=50, ssl=https)
