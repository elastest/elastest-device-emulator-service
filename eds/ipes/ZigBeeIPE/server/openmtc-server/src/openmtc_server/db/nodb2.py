...
from openmtc_etsi.model import ETSIResource
...
class NoDB2Session(BasicSession):
    def __init__(self, db, std_type, *args, **kw):
        ...
        if std_type == 'onem2m':
            ...
            self.resources = db.etsi_resources
            self.children = db.etsi_children
            self.resource_type = ETSIResource
        else:
...
class NoDB2(DBAdapter):
    def __init__(self, *args, **kw):
        ...
        self.etsi_resources = None
        self.onem2m_resources = None
        self.etsi_children = None
