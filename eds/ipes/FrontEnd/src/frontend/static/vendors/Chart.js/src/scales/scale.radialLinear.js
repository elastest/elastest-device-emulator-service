...
module.exports = function(Chart) {
	...
	var LinearRadialScale = Chart.Scale.extend({
		...
		fit: function() {
			 ...
			 * from the shape radius to move the point inwards by that orchestrator.
			 *
			 * We average the left and right distances to get the maximum shape radius that can fit in the box
			 * along with labels.
			 *
			 * Once we have that, we can find the centre point for the chart, by taking the orchestrator text protrusion
			 * on each side, removing that from the size, halving it and adding the left orchestrator protrusion width.
			 *
