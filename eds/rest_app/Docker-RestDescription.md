...
This is the image for the rest api application of Elastest Device Emulator Service.
...
It collects  all sensor information from different sensor application via gateway  in a restfull way.  
