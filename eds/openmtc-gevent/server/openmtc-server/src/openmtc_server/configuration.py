...
class GlobalConfiguration(Configuration):
    ...
    __options__ = {"disable_retargeting": BooleanOption(default=False)}
...
class ConnectorSpecConfiguration(Configuration):
    __name__ = "Connector Spec configuration"
    __options__ = {"scheme": SimpleOption(default=None),
                   "hostname": SimpleOption(default=None),
